    ...
    <?php
        ...
        <div class="menu">
            <ul>
                ...
                <li class="appmenu"><a class="active" href="needEducation.php">Education Information</a></li>
        ...
        <form action="noaction.php" class="myform">
            ...
            <center>
                <div class="next">
                    <a href="needPersonal.php" class="footbutton">Previous</a>
                    <a href="needFinancial.php" class="footbutton">Next</a>
                </div>
            </center>
        </form>
    </div>
